...
nhl.data.clean1$GeneralInjury = replace(nhl.data.clean1$GeneralInjury, grep("mouth|jaw|oral", nhl.data.clean1$GeneralInjury), "hand")
...
write.table(as.matrix(nhl.data.clean1), "Clean-Data/NHL_Clean_V12.txt", sep="\t")
```
...
- Understand model implication sand correct use case (ie. assumptions that are broken when running a test)
